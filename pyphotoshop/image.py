...
class Image:
    def __init__(self, x_pixels=0, y_pixels=0, num_channels=0, filename=''):
        ...
        # num_channels: rgb -> 3 channels 
        # xy define the size of the image
        ...
        elif filename: # alternative input option 
    ...
    def read_image(self, filename, gamma=2.2): # gamma is important for transformation process
        '''
...
if __name__ == '__main__':
    ...
    # im.write_image('test_v3.png')

    # im = Image(filename='lake.png')
    # im.write_image('lake_copy.png')

    im = Image(filename='Italia1.png')
    im.write_image('Italia1_copy.png')

    im = Image(filename='Italia2.png')
    im.write_image('Italia2_copy.png')
